...
We could see there is too noise, and this could logical, thinking of how the diseases works: There are not a few genes that works out to produce the disease, it's a bunch of them, but not all of them. There are important genes and irrelevant ones. So, these filters are biological consistent.
