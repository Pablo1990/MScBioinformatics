...
As we can see in Table \ref{table:basicsResults63142} and \ref{table:filteredResults63142}, the results and performance obtained are approximately the same of the another dataset. So, with all of this results, and seen the performance done after the FSS. We can say that the genes obtained with this filter could be interesting of study. In the next section, we'll discuss about this.
