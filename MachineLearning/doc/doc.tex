...
The genes obtained by FSS are, as seen by the results, at least, important to discriminate between the several classes in each dataset. But, we do different fss in which every of them, we get diverse genes.
